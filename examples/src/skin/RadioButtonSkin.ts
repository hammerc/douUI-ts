namespace skin {
     ...
     * @author wizardc
     */
    export class RadioButtonSkin extends Dou.SkinBase {
        private _group: Dou.Group;
        private _bg: Dou.Image;
        private _label: Dou.Label;

        private _unselectSource: string = "radiobutton_unselect_png";
        private _upSource: string = "radiobutton_select_up_png";
        private _downSource: string = "radiobutton_select_down_png";
        private _disableSource: string = "radiobutton_select_disabled_png";

        private _cbLabel: string = "RadioButton";
