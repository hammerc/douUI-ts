...
(function (skin) {
     ...
     * @author wizardc
     */
    class CheckBoxSkin extends Dou.SkinBase {
        constructor(target) {
            super(target, { minWidth: 60, minHeight: 20 });
            this._unselectSource = "checkbox_unselect_png";
            this._upSource = "checkbox_select_up_png";
            this._downSource = "checkbox_select_down_png";
            this._disableSource = "checkbox_select_disabled_png";
            this._cbLabel = "CheckBox";
        }
        createSkin() {
    ...
    skin.CheckBoxSkin = CheckBoxSkin;
})(skin || (skin = {}));
