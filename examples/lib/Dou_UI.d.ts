...
declare namespace Dou.sys {
     ...
     * @author wizardc
     */
    interface IUIComponent extends Dou.DisplayObject {
        /**
         * 接口类型
         */
         ...
         */
        getLayoutBounds(bounds: Dou.Rectangle): void;
        /**
         * 获取组件的首选尺寸, 常用于父级的 measure() 方法中
         * 按照: 外部显式设置尺寸 -> 测量尺寸 的优先级顺序返回尺寸
         * * 注意此方法返回值已经包含 scale 和 rotation
         */
        getPreferredBounds(bounds: Dou.Rectangle): void;
    }
}
declare namespace Dou.sys {
    /**
     ...
     * @author wizardc
     */
    class UIComponentImpl extends Dou.DisplayObject implements IUIComponent {
        __interface_type__: "douUI.sys.IUIComponent";
        /**
         * 父类引用
         */
        ...
        $onAddToStage(stage: Dou.Stage, nestLevel: number): void;
        /**
         * 检查属性失效标记并应用
         */
        ...
        $setMatrix(matrix: Dou.Matrix, needUpdateProperties?: boolean): boolean;
...
declare namespace Dou {
     ...
     * @author wizardc
     */
    abstract class Component extends Dou.DisplayObjectContainer implements sys.IUIComponent {
        $Component: Object;
        constructor();
        /**
         * 组件是否可以接受用户交互
...
declare namespace Dou {
    ...
    abstract class SliderBase extends Range {
         ...
         * 轨道高亮显示对象
         */
        trackHighlight: Dou.DisplayObject;
        /**
         * 滑块显示对象
         */
        thumb: Component;
        ...
        protected onThumbTouchBegin(event: Dou.TouchEvent): void;
        private onStageTouchMove;
        protected updateWhenTouchMove(newValue: number): void;
        protected onStageTouchEnd(event: Dou.TouchEvent): void;
        protected onTrackTouchBegin(event: Dou.TouchEvent): void;
    }
}
declare namespace Dou.sys {
    /**
...
declare namespace Dou {
     ...
     * @author wizardc
     */
    class Label extends Dou.TextField implements sys.IUIComponent {
...
declare namespace Dou {
     ...
     * @author wizardc
     */
    class BitmapLabel extends Dou.BitmapText implements sys.IUIComponent {
        private _widthConstraint;
...
declare namespace Dou {
     ...
     * @author wizardc
     */
    class EditableText extends Dou.TextField implements sys.IUIComponent {
        $EditableText: Object;
        private _widthConstraint;
...
declare namespace Dou {
     ...
     * @author wizardc
     */
    class Image extends Dou.Bitmap implements sys.IUIComponent {
        private _source;
        private _sourceChanged;
        constructor(source?: string | Dou.Texture);
        set source(value: string | Dou.Texture);
        get source(): string | Dou.Texture;
        $setScale9Grid(value: Dou.Rectangle): void;
        $setFillMode(value: Dou.BitmapFillMode): boolean;
        $setTexture(value: Dou.Texture): boolean;
        private parseSource;
        $measureContentBounds(bounds: Dou.Rectangle): void;
        __interface_type__: "douUI.sys.IUIComponent";
        $UIComponent: Object;
        /**
         * UIComponentImpl 定义的所有变量请不要添加任何初始值, 必须统一在此处初始化
...
declare namespace Dou {
    ...
    class Button extends Component {
        ...
        constructor();
        protected onTouchBegin(event: Dou.TouchEvent): void;
        protected onTouchCancle(event: Dou.TouchEvent): void;
...
declare namespace Dou {
     ...
     * @author wizardc
     */
    class Group extends Dou.DisplayObjectContainer implements IViewport {
        $Group: Object;
         ...
         * 获取一个布局元素子项
         */
        getElementAt(index: number): Dou.DisplayObject;
        /**
         * 获取一个虚拟布局元素子项
         */
        getVirtualElementAt(index: number): Dou.DisplayObject;
        /**
         * 在支持虚拟布局的容器中, 设置容器内可见的子元素索引范围
         */
        setVirtualElementIndicesInView(startIndex: number, endIndex: number): void;
        $hitTest(stageX: number, stageY: number): Dou.DisplayObject;
        __interface_type__: "douUI.sys.IUIComponent";
        $UIComponent: Object;
        /**
         * UIComponentImpl 定义的所有变量请不要添加任何初始值, 必须统一在此处初始化
...
declare namespace Dou {
    ...
    class ListBase extends DataGroup {
        ...
        protected rendererAdded(renderer: IItemRenderer, index: number, item: any): void;
        protected rendererRemoved(renderer: IItemRenderer, index: number, item: any): void;
        protected onRendererTouchBegin(event: Dou.TouchEvent): void;
        protected onRendererTouchCancle(event: Dou.TouchEvent): void;
        protected onRendererTouchEnd(event: Dou.TouchEvent): void;
        private onStageTouchEnd;
    }
}
declare namespace Dou {
...
declare namespace Dou {
    ...
    export class RichLabel extends Group {
        ...
        get italic(): boolean;
        set textAlign(value: Dou.HorizontalAlign);
        get textAlign(): Dou.HorizontalAlign;
        set verticalAlign(value: Dou.VerticalAlign);
        get verticalAlign(): Dou.VerticalAlign;
...
declare namespace Dou {
    ...
    class ViewStack extends Group implements ICollection {
         ...
         * 当前可见的子项
         */
        set selectedChild(value: Dou.DisplayObject);
        get selectedChild(): Dou.DisplayObject;
        /**
         * 当前选择的可见子项的索引
         */
        set selectedIndex(value: number);
        ...
        $childAdded(child: Dou.DisplayObject, index: number): void;
        $childRemoved(child: Dou.DisplayObject, index: number): void;
        protected commitProperties(): void;
...
declare module Dou {
    interface EventDispatcher {
         ...
         * 抛出集合数据改变事件
         */
        dispatchCollectionEvent(type: string, kind?: Dou.CollectionEventKind, location?: number, oldLocation?: number, items?: any[], oldItems?: any[], cancelable?: boolean): boolean;
    }
}
declare namespace Dou {
    /**
...
declare module Dou {
    interface EventDispatcher {
         ...
         * 抛出列表项触碰事件
         */
        dispatchItemTapEvent(type: string, itemRenderer?: Dou.IItemRenderer): boolean;
    }
}
declare namespace Dou {
    /**
     ...
     * @author wizardc
     */
    class ItemTapEvent extends Dou.Event2D {
        /**
         * 列表项触碰
         */
...
declare namespace Dou {
     ...
     * @author wizardc
     */
    class UIEvent extends Dou.Event2D {
        /**
         * 组件创建完成
         */
...
declare namespace Dou {
    ...
    abstract class LinearLayoutBase extends LayoutBase {
        protected _horizontalAlign: Dou.HorizontalAlign | JustifyAlign;
        protected _verticalAlign: Dou.VerticalAlign | JustifyAlign;
         ...
         * 布局元素的水平对齐策略
         */
        set horizontalAlign(value: Dou.HorizontalAlign | JustifyAlign);
        get horizontalAlign(): Dou.HorizontalAlign | JustifyAlign;
        /**
         * 布局元素的垂直对齐策略
         */
        set verticalAlign(value: Dou.VerticalAlign | JustifyAlign);
        get verticalAlign(): Dou.VerticalAlign | JustifyAlign;
        /**
         * 布局元素之间的间隔
         */
...
declare namespace Dou {
    ...
    abstract class SkinBase implements ISkin {
         ...
         * 将特定的实例绑定到目标对象的指定属性上
         */
        protected bindToTarget(attributeName: string, instance: Dou.DisplayObject): void;
...
declare namespace Dou.sys {
     ...
     */
    function updateDisplayList(target: Group | Component, unscaledWidth: number, unscaledHeight: number): Dou.Recyclable<Dou.Point>;
}
declare namespace Dou.sys {
    /**
     * 矩阵工具类
    ...
    namespace MatrixUtil {
        function isDeltaIdentity(m: Dou.Matrix): boolean;
        function fitBounds(width: number, height: number, matrix: Dou.Matrix, explicitWidth: number, explicitHeight: number, preferredWidth: number, preferredHeight: number, minWidth: number, minHeight: number, maxWidth: number, maxHeight: number): Dou.Recyclable<Dou.Point>;
    }
}
declare namespace Dou {
    /**
